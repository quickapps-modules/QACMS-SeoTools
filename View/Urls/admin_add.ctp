<?php echo $this->Form->create('SeoUrl'); ?>
    <?php echo $this->Html->useTag('fieldsetstart', __d('seo_tools', 'Optimize new URL')); ?>
		...
		<div style="float:left; clear:left; width:100%;">
			<?php echo $this->Form->input('SeoUrl.status', array('type' => 'checkbox', 'checked' => true, 'label' => __d('seo_tools', 'Optimization Active'))); ?>
			...
			<?php
				echo $this->Form->input('SeoUrl.url',
					array(
						...
						'label' => 'URL *',
						'after' =>
							$this->Html->link($this->Html->image('/seo_tools/img/icon-download.gif'), '',
								array(
									'class' => 'retrieve-page',
									'title' => __d('seo_tools', 'Retrieve information and auto-fill.'),
									'escape' => false,
									'style' => 'display:none;'
								)
							),

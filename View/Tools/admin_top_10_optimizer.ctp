...
<div class="report" id="top10_report">
    ...
    <fieldset>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablekit"><!-- table of contents -->
            <thead>
                <tr>
...
<div id="chart_results" style="display:none;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablekit"><!-- chart -->
        <thead>
            <tr>

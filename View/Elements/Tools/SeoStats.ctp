    ...
    <tbody>
        <tr>
            ...
            <td align="left" valign="top">
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/google-backlink.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/yahoo-indexed.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                    <?php echo __t('Yahoo Indexed Pages'); ?>: <a href="http://siteexplorer.search.yahoo.com/search?p=<?php echo $results['url']; ?>" target="_blank"><b><?php echo $results['yahooindexed']; ?></b></a>
                </span>
                                    
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/bing.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/digg.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/delicious.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/technorati.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/compete.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/site-value.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/w3c.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/archive.png", array('border' => 0, 'align' => 'absmiddle') ); ?>
                ...
                <span class="imageDouble" style="width:300px;">
                    <?php echo $this->Html->image("/{$this->plugin}/img/seo-stats-icons/google-bot.png", array('border' => 0, 'align' => 'absmiddle') ); ?>

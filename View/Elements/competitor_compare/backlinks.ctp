<table width="100%" border="0" cellspacing="0" cellpadding="0"><!-- alexa rank -->
    ...
    <tbody>
        <tr>
            ...
            <td width="23%" height="20" align="left"><b><?php echo __t('Alexa'); ?></b></td>
            <td width="23%" height="20" align="left"><b><?php echo __t('Google.com'); ?></b></td>
            <td width="23%" align="left"><b><?php echo __t('Yahoo.com'); ?></b></td>
            <td width="21%" align="left"><b><?php echo __t('Peak Value'); ?></b></td>
        </tr>
        ...
        <tr>
            <td align="center" valign="middle"><?php echo __t('Top Site'); ?> <?php echo $index+1; ?></td>
            ...
            <td align="left" valign="left" colspan="5">
                <?php 
                    switch($color){
                        ...
                        case 1:
                            $msg = __t('Summing up all analyzed search engines, there are at least as many web pages linking to your page as to the top ranked pages. This meets the basic requirements for getting high rankings on %s. Keep in mind that all search engines also evaluate the link texts and the quality of the web pages that link to your web site');
                            $msg = sprintf($msg, $this->data['Tool']['engine']);
                        break;
                        
                        case 2:
                            $msg = __t('Summing up all analyzed search engines, you have more web pages linking to your web page than the top ranking web pages. This is very good. However, %s also evaluates the link texts and the quality of the web pages that link to your web site');
                            $msg = sprintf($msg, $this->data['Tool']['engine']);
                        break;
                    }

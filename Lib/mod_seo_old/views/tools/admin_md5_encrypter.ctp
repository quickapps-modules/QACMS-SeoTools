...
<div style="width:100%; height:auto; overflow-y:auto;">
	<form id="toolForm" action="<?php echo $this->Html->url("/{$this->plugin}/tools/{$this->params['action']}"); ?>" method="post" onsubmit="tool_exe(400); return false;">
...
<div style="width:100%; height:auto; overflow-y:auto; overflow-x:hidden;">
	<h1><?phpecho __t('MD5 Encrypter'); ?></h1>

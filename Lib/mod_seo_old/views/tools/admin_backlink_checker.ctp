...
<div style="width:100%; height:80px; overflow-y:auto;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablekit">
		<thead>
			<tr>
				<td width="59%" align="left" valign="top"><b><?phpecho __t('URL'); ?></b></td>
				<td width="13%" align="center" valign="top"><b><?phpecho __t('BL Alexa'); ?></b></td>
				<td width="16%" align="center" valign="top"><b><?phpecho __t('BL Google'); ?></b></td>
				<td width="12%" align="center" valign="top"><b><?phpecho __t('BL Yahoo'); ?></b></td>
			</tr>
		</thead>
